...
import (
	...
	"github.com/pytorch-operator/pytorch-operator/internal/controller"
)
...
func init() {
	...
	utilruntime.Must(pytorchv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "pytorch-operator.nvidia.com",
	})
	if err != nil {
	...
	setupLog.Info("starting pytorch-operator manager")
